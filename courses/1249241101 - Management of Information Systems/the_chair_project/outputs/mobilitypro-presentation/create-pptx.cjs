...
async function createPresentation() {
    ...
    console.log('Creating Slide 2: Problem & Solution...');
    await html2pptx(path.join(baseDir, 'slide2-problem-solution.html'), pptx);

    // Slide 3: Technology & Data
    console.log('Creating Slide 3: Technology & Data...');
    await html2pptx(path.join(baseDir, 'slide3-technology.html'), pptx);

    // Slide 4: Business Model
    console.log('Creating Slide 4: Business Model...');
    await html2pptx(path.join(baseDir, 'slide4-business.html'), pptx);

    // Save the presentation
    const outputPath = path.join(baseDir, 'MobilityPro-Health-Pitch.pptx');
